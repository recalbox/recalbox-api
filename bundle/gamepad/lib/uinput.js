...
/**
 * Found here: https://github.com/miroof/node-virtual-gamepads
 */


let uinput = {};

uinput.UI_SET_EVBIT = _io2.default._IOW(_io2.default.UINPUT_IOCTL_BASE, 100, _io2.default['int']);
uinput.UI_SET_KEYBIT = _io2.default._IOW(_io2.default.UINPUT_IOCTL_BASE, 101, _io2.default['int']);
uinput.UI_SET_RELBIT = _io2.default._IOW(_io2.default.UINPUT_IOCTL_BASE, 102, _io2.default['int']);
uinput.UI_SET_ABSBIT = _io2.default._IOW(_io2.default.UINPUT_IOCTL_BASE, 103, _io2.default['int']);

uinput.UI_DEV_CREATE = _io2.default._IO(_io2.default.UINPUT_IOCTL_BASE, 1);
uinput.UI_DEV_DESTROY = _io2.default._IO(_io2.default.UINPUT_IOCTL_BASE, 2);

...
class PadSnes extends _Pad2.default {
    ...
    *sendEvent(event) {
        ...
        var input_event = (0, _struct2.default)().struct('time', (0, _struct2.default)().word32Sle('tv_sec').word32Sle('tv_usec')).word16Ule('type').word16Ule('code').word32Sle('value');
        ...
        var input_event_end = (0, _struct2.default)().struct('time', (0, _struct2.default)().word32Sle('tv_sec').word32Sle('tv_usec')).word16Ule('type').word16Ule('code').word32Sle('value');

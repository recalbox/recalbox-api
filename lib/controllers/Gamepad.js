...
class Gamepad {
    ...
    *connect(request, response) {
        ...
        var padType = yield request.getRawBody();
    ...
    *disconnect(request, response) {
        ...
        var padIndex = request.getParameter("index");
        ...
        var pad = this.pads.get(padIndex);
    ...
    *setButtonA(request, response) {
        ...
        var pad = this.pads.get(padIndex);
        var value = yield request.getRawBody();
    ...
    *createCombo(request, response) {
        ...
        var pad = this.pads.get(padIndex);
        var comboJson = yield request.getRawBody();
        comboJson = comboJson.toString();

        // Parse the combo
        var combo = new _Combo2.default(pad);
        try {
